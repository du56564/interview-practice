package interview.lld.interviewmain.basics;
...
/*
hash("S0-0") → 12  -> ring.put(12, "S0")
hash("S0-1") → 47  -> ring.put(47, "S0")
hash("S0-2") → 91  -> ring.put(91, "S0")

hash("UserA") = 60
ring.ceilingEntry(60)
65 -> S4 or UserA → S4
